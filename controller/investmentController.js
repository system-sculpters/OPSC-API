...
const getTop40Data = async (req, res) => {
  try {
    ...
    res.status(200).json({ message: 'Filtered stocks data retrieved successfully.', data: filteredStocks });
...
module.exports = { getUserInvestments, buyInvestment, sellInvestment, getStocks, getStockBySymbol, getTop40Stocks, getBatchStocks, updateStockLogos, getTop40Data}